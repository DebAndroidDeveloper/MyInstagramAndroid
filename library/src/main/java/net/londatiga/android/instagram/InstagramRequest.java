...
public class InstagramRequest {
	 ...
	 */
	public String createRequest(String method, String endpoint, Map<String, String> params) throws Exception {
	 ...
	 * 
	 */
	public void createRequest(String method, String endpoint, Map<String, String> params, InstagramRequestListener listener) {
	 ...
	 * @throws Exception If error occured.
	 */
	private String requestGet(String endpoint, Map<String, String> params) throws Exception {
	 ...
	 * @throws Exception If error occured.
	 */
	private String requestPost(String endpoint, Map<String, String> params) throws Exception {
		String requestUri = Cons.API_BASE_URL + ((endpoint.indexOf("/") == 0) ? endpoint : "/" + endpoint);
	 ...
	 * @throws Exception If error occured.
	 */
	public String get(String requestUri, Map<String, String> params) throws Exception {
		...
		try {
			...
			if (!mAccessToken.equals("")) {
				if (params == null) {
					...
					//params.add(new HashMap<String, String>("access_token", mAccessToken));
			...
			if (params != null) {
				...
				while (iterator.hasNext()){
					...
					requestParamSb.append(entry.getKey() + "=" + entry.getValue());
					requestParamSb.append("&");
				}

				requestParamSb.deleteCharAt(requestParamSb.length() - 1);
...
//
	 ...
	 * @throws Exception If error occured.
	 */
	public String post(String requestUrl, Map<String, String> params) throws Exception {
		InputStream stream 	= null;
		String response		= "";
		...
		try {
			...
			Debug.i("POST URL: " + requestUrl);
			
			HttpClient httpClient 	= new DefaultHttpClient();
			HttpPost httpPost 		= new HttpPost(requestUrl);

	        //httpPost.setEntity(new UrlEncodedFormEntity(params));
			//StringEntity dateSentToServer = new StringEntity(req)
			httpPost.setEntity(new StringEntity(requestParamSb.toString().trim()));
	...
	private class RequestTask extends AsyncTask<URL, Integer, Long> {
		...
		public RequestTask(String method, String endpoint,  Map<String, String> params, InstagramRequestListener listener) {
			this.method		= method;
